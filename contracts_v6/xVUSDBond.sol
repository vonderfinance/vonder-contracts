...
contract ERC20 is Context, IERC20, Ownable {
    ...
    */
    ...
    function _transferWithLock (address sender, address recipient, uint256 amount) internal {
        ...
        uint256 _amount = amount.sub(_amountLock, 'ERC20: transfer amount exceeds balance'); // 30%
...
// xVUSDBar is the coolest bar in town. You come in with some xVUSD, and leave with more! The longer you stay, the more VUSD you get.
//
// This contract handles swapping to and from VUSD, SushiSwap's staking token.
contract xVUSDBond is ERC20("Extended VUSD Bond", "xVUSDB") {
    using SafeMath for uint256;
    IERC20 public sushi;

    // Define the xVUSD token contract
    constructor(IERC20 _xvusd) public {
        sushi = _xvusd;
    }
